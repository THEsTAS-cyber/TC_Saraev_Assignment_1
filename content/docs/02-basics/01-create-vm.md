...
6. If you see the red exclamation mark in the "PASSWORD" field then the condition on the password is not satisfied (see [Password requirements](../03-functions/02-details-login/)).
